    ...
    static const QVector<ProviderDef> defs = {
        ...
        {"email", "Email", "📧",
         {{"smtp_host", "SMTP Host", "smtp.gmail.com"},
          ...
          {"to_addr",   "To Address","recipient address"},
          {"from_addr", "From Address","sender address (optional)"}}},
        {"whatsapp", "WhatsApp", "📱",
         {{"account_sid", "Account SID", "Twilio Account SID"},
          {"auth_token",  "Auth Token",  "Twilio Auth Token", true},
          {"from_number", "From Number", "Sender number"},
          {"to_number",   "To Number",   "Recipient number"}}},
        {"pushover", "Pushover", "🔔",
        ...
        {"mattermost", "Mattermost", "🟦",
         {{"webhook_url", "Webhook URL", "https://your-mattermost.com/hooks/..."},
          ...
          {"username",    "Username",    "Pinpunch (optional)"}}},
        {"teams", "MS Teams", "🟪",
