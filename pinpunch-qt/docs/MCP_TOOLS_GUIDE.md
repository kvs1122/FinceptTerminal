...
`pinpunch-qt/plans/mcp-refactor-INDEX.md`).
...
- Refactor plans: `pinpunch-qt/plans/mcp-refactor-phase-{1..6}-*.md`
- Refactor index: `pinpunch-qt/plans/mcp-refactor-INDEX.md`
- Datahub: `pinpunch-qt/DATAHUB_ARCHITECTURE.md`
- Hub topics: `pinpunch-qt/docs/DATAHUB_TOPICS.md`
- Project rules: `pinpunch-qt/CLAUDE.md`
