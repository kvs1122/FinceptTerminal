...
### Deliverables
- **CLAUDE.md updates:** ✅ rules D1–D5 added (`pinpunch-qt/CLAUDE.md` §D). D4 was refined after audit to distinguish streaming data (hub-only) from one-shot catalog/info lookups (callback APIs may stay).
