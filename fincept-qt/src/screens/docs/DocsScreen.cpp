...
QWidget* DocsScreen::page_welcome() {
    ...
    vl->addWidget(make_heading("PINPUNCH TERMINAL  —  DOCUMENTATION"));
    ...
    vl->addWidget(
        make_section_panel("■", "WHAT IS PINPUNCH TERMINAL?",
                           "Pinpunch Terminal is a professional-grade desktop financial intelligence platform "
                           ...
                           "and support for 15+ broker integrations, Pinpunch Terminal bridges the gap between "
...
QWidget* DocsScreen::page_getting_started() {
    ...
    vl->addWidget(make_muted_label("Your first steps with Pinpunch Terminal"));
    ...
    vl->addWidget(make_section_panel("1", "LAUNCH & LOGIN",
                                     "When you first launch Pinpunch Terminal, you'll see the login screen. "
                                     "You can either:\n\n"
    ...
    vl->addWidget(make_section_panel("4", "SUBSCRIPTION PLANS",
                                     "Pinpunch Terminal offers tiered access:\n\n"
...
DocsScreen::DocsScreen(QWidget* parent) : QWidget(parent) {
    ...
    breadcrumb_ = new QLabel("PINPUNCH TERMINAL v4.0.0");
